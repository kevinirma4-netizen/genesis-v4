...
${a.customMessage}`
            ...
            .setFooter({
                text:
                    '✦ READY • NOT READY • RE-PING • A U R E O N ✦'
            })
    );
}
...
function scrimResultControlEmbed(
    ...
    return setBanner(
        new EmbedBuilder()
            ...
            .setAuthor({
                name:
                    '✦ A U R E O N • S C R I M  R E S U L T S ✦'
            })
            .setTitle(
...
${mvp}`
            ...
            .setFooter({
                text:
                    '✦ PRIVATE HOST CONTROL • A U R E O N ✦'
            })
    );
}
...
function scrimResultPublicEmbed(
    ...
    return setBanner(
        new EmbedBuilder()
            ...
            .setAuthor({
                name:
                    '✦ A U R E O N • S C R I M  R E S U L T ✦'
            })
            .setTitle(
...
✦ **MATCH TYPE:** ${result.type.toUpperCase()}\n\n` +
            ...
            .setFooter({
                text:
                    '✦ A U R E O N • OFFICIAL SCRIM RESULT ✦'
            })
    );
}
                        ...
                        embeds: [
                            setBanner(
                                new EmbedBuilder()
                                    .setColor(GOLD)
                                    .setAuthor({
                                        name: '✦ A U R E O N • T R Y O U T  R E S U L T S ✦'
                                    })
                        ...
                        embeds: [
                            setBanner(
                                new EmbedBuilder()
                                    ...
                                    .setAuthor({
                                        name:
                                            '✦ A U R E O N • L E A D E R B O A R D ✦'
                                    })
                                    .setTitle(
                                        '◇ TRYOUT LEADERBOARD'
                                    )
                        ...
                        embeds: [
                            setBanner(
                                new EmbedBuilder()
                                    ...
                                    .setAuthor({
                                        name:
                                            '✦ A U R E O N • P L A Y E R  P R O F I L E ✦'
                                    })
                                    .setTitle(
                                        user.username
                                    )
